...
class PyBulletGimbalDriver:
    ...
    def reset(self, yaw_deg: float = 0.0, pitch_deg: float = 0.0) -> None:
        ...
        p = self._p
        p.resetJointState(self._robot, self._yaw_idx,
                          math.radians(yaw_deg))
        p.resetJointState(self._robot, self._pitch_idx,
    ...
    def __repr__(self) -> str:
        return (
            f"PyBulletGimbalDriver("
            f"yaw_idx={self._yaw_idx}, pitch_idx={self._pitch_idx})"
        )
